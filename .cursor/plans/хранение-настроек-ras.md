...
todos:
  ...
  - id: infobases
    ...
    status: pending
  - id: forms
    content: Формы списка и элемента всех трёх справочников; пароль учётной записи — только в форме, запись/очистка через безопасное хранилище, удаление пароля в ПередУдалением
    status: pending
  - id: subsystem
...
Формы списка и элемента у всех трёх. Код справочника в формах не показывать.
