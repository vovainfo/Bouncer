...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// <<МОДИФИКАЦИЯ - Поставляемые профили операторов техподдержки
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя = "ОператорТехподдержки";
	ОписаниеПрофиля.Идентификатор = "e31e0989-299d-4f59-9e72-f6c8c1692473";
	ОписаниеПрофиля.Наименование = НСтр("ru = 'Оператор техподдержки'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Описание =
		НСтр("ru = 'Завершение сеансов во всех информационных базах кластера.
		|Нельзя менять настройки блокировки сеансов и регламентных заданий.'");
	ДобавитьРолиПрофиляОператора(ОписаниеПрофиля);
	ОписаниеПрофиля.Роли.Добавить("ОператорТехподдержки");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя = "ОграниченныйОператорТехподдержки";
	ОписаниеПрофиля.Идентификатор = "d6043cd2-e503-445b-8d09-f6f0b7831834";
	ОписаниеПрофиля.Наименование = НСтр("ru = 'Ограниченный оператор техподдержки'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Описание =
		НСтр("ru = 'Завершение сеансов только в разрешенных информационных базах.
		|Можно завершать только тонкий и толстый клиент.
		|Нельзя менять настройки блокировки сеансов и регламентных заданий.'");
	ДобавитьРолиПрофиляОператора(ОписаниеПрофиля);
	ОписаниеПрофиля.Роли.Добавить("ОграниченныйОператорТехподдержки");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	// >>
	
КонецПроцедуры
Процедура ДобавитьРолиПрофиляОператора(ОписаниеПрофиля)
